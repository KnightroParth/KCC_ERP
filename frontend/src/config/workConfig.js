...
export const SUB_CATEGORY_ALIASES = {
    ...
    // Water Proofing (do not alias First Coat to Chipping – they have different rates)
    "Chipping & Leakage Pipe": ["Chipping & Leakage Pipe", "Chipping"],
    "First Coat": ["First Coat", "1st Coat"],
    ...
    // Civil Work (Excel uses Hall, Balcony, Kitchen, Toilet1, Bedroom1, etc.)
    "CW-Hall": ["CW-Hall", "Hall", "Door Frame Fitting"],
    "CW-Balcony": ["CW-Balcony", "Balcony"],
    "CW-Kitchen": ["CW-Kitchen", "Kitchen"],
    "CW-Toilet1": ["CW-Toilet1", "Toilet1"],
    "CW-Toilet2": ["CW-Toilet2", "Toilet2"],
    "CW-Toilet3": ["CW-Toilet3", "Toilet3"],
    "CW-Bedroom1": ["CW-Bedroom1", "Bedroom1"],
    "CW-Bedroom2": ["CW-Bedroom2", "Bedroom2"],
    "CW-Bedroom3": ["CW-Bedroom3", "Bedroom3"],
    "LC-Hall": ["LC-Hall", "Hall"],
    "LC-Balcony": ["LC-Balcony", "Balcony"],
    "LC-Kitchen": ["LC-Kitchen", "Kitchen"],
    "LC-Toilet1": ["LC-Toilet1", "Toilet1"],
    "LC-Toilet2": ["LC-Toilet2", "Toilet2"],
    "LC-Toilet3": ["LC-Toilet3", "Toilet3"],
    "LC-Bedroom1": ["LC-Bedroom1", "Bedroom1"],
    "LC-Bedroom2": ["LC-Bedroom2", "Bedroom2"],
    "LC-Bedroom3": ["LC-Bedroom3", "Bedroom3"],
    "LCast-Hall": ["LCast-Hall", "Hall"],
    "LCast-Balcony": ["LCast-Balcony", "Balcony"],
    "LCast-Kitchen": ["LCast-Kitchen", "Kitchen"],
    "LCast-Toilet1": ["LCast-Toilet1", "Toilet1"],
    "LCast-Toilet2": ["LCast-Toilet2", "Toilet2"],
    "LCast-Toilet3": ["LCast-Toilet3", "Toilet3"],
    "LCast-Bedroom1": ["LCast-Bedroom1", "Bedroom1"],
    "LCast-Bedroom2": ["LCast-Bedroom2", "Bedroom2"],
    "LCast-Bedroom3": ["LCast-Bedroom3", "Bedroom3"],
    // Finishing-W (Excel: Hall, Balcony, Kitchen, Toilet-1, Toilet-2, Toilet-3, BedRoom-1, BedRoom-2, BedRoom-3)
    "FW-Hall": ["FW-Hall", "Hall"],
    "FW-Balcony": ["FW-Balcony", "Balcony"],
    "FW-Kitchen": ["FW-Kitchen", "Kitchen"],
    "FW-Toilet-1": ["FW-Toilet-1", "Toilet-1"],
    "FW-Toilet-2": ["FW-Toilet-2", "Toilet-2"],
    "FW-Toilet-3": ["FW-Toilet-3", "Toilet-3"],
    "FW-BedRoom-1": ["FW-BedRoom-1", "BedRoom-1"],
    "FW-BedRoom-2": ["FW-BedRoom-2", "BedRoom-2"],
    "FW-BedRoom-3": ["FW-BedRoom-3", "BedRoom-3"],
    // Finishing-D (Excel: Hall, Balcony, Kitchen, Toilet1, Toilet2, Toilet3, Bedroom1, Bedroom2, Bedroom3)
    "FD-Hall": ["FD-Hall", "Hall"],
    "FD-Balcony": ["FD-Balcony", "Balcony"],
    "FD-Kitchen": ["FD-Kitchen", "Kitchen"],
    "FD-Toilet1": ["FD-Toilet1", "Toilet1"],
    "FD-Toilet2": ["FD-Toilet2", "Toilet2"],
    "FD-Toilet3": ["FD-Toilet3", "Toilet3"],
    "FD-Bedroom1": ["FD-Bedroom1", "Bedroom1"],
    "FD-Bedroom2": ["FD-Bedroom2", "Bedroom2"],
    "FD-Bedroom3": ["FD-Bedroom3", "Bedroom3"],
};
