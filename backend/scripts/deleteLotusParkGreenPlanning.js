/**
 * One-time script: Delete ALL PlannedWork records for Lotus Green and Lotus Park.
 * Lotus Heights is NOT touched.
 * Run from /backend:  node scripts/deleteLotusParkGreenPlanning.js
 */
...
async function main() {
    ...
    const result = await PlannedWork.deleteMany({
        $or: [
    ...
    console.log(`\n✅ Deleted ${result.deletedCount} PlannedWork records for Lotus Green & Lotus Park.`);
